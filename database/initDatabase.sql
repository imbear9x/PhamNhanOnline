...
CREATE TABLE IF NOT EXISTS public.herb_templates (
    ...
    replant_return_chance double precision NOT NULL DEFAULT 0.3,
    description text NULL,
    created_at timestamp without time zone NOT NULL DEFAULT now(),
...
ALTER TABLE public.player_herbs
    ADD COLUMN IF NOT EXISTS expire_at timestamp without time zone NULL;

ALTER TABLE public.herb_templates
    ADD COLUMN IF NOT EXISTS replant_return_chance double precision NOT NULL DEFAULT 0.3;
...
CREATE TABLE IF NOT EXISTS public.pill_recipe_templates (
    ...
    description text NULL,
    craft_duration_seconds bigint NOT NULL DEFAULT 10,
...
CREATE TABLE IF NOT EXISTS public.enemy_templates (
    ...
    ai_behavior integer NOT NULL DEFAULT 1,
    max_hp integer NOT NULL,
    base_attack integer NOT NULL DEFAULT 0,
    base_move_speed numeric(10, 4) NOT NULL DEFAULT 100.0,
    patrol_pause_seconds_min numeric(10, 4) NOT NULL DEFAULT 0,
    patrol_pause_seconds_max numeric(10, 4) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS public.map_enemy_spawn_groups (
    ...
    patrol_radius real NOT NULL DEFAULT 0,
    patrol_route_type integer NOT NULL DEFAULT 1,
    description text NULL,
    created_at timestamp without time zone NOT NULL DEFAULT now(),
...
INSERT INTO public.enemy_templates (
    ...
    base_attack,
    base_move_speed,
    patrol_pause_seconds_min,
    patrol_pause_seconds_max,
    detection_radius,
    combat_radius,
...
SET
    ...
    patrol_pause_seconds_min = EXCLUDED.patrol_pause_seconds_min,
    patrol_pause_seconds_max = EXCLUDED.patrol_pause_seconds_max,
...
SET
    ...
    patrol_route_type = EXCLUDED.patrol_route_type,
    description = EXCLUDED.description;
...
VALUES
    ...
    ('herb.inventory_expiry_seconds', '604800', 'So giay linh duoc sau khi thu hoach ton tai trong tui truoc khi het han.'),
    ('herb.expiry_sweep_interval_seconds', '60', 'Chu ky quet xoa linh duoc het han trong tui theo giay.')
