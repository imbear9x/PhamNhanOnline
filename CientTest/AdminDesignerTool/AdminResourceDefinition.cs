...
internal static class AdminResourceCatalog
{
    public static IReadOnlyList<AdminResourceDefinition> Build()
    {
        ...
        [
            ...
            new("character_martial_art_workspace", "Designer Workspace", "Character Martial Arts Workspace", string.Empty, null, "Workspace để tick công pháp đã sở hữu cho từng nhân vật.", "Chọn nhân vật ở bảng trên. Danh sách công pháp bên dưới hiện checkbox sở hữu. Tick để cấp công pháp cho nhân vật, bỏ tick để gỡ công pháp. Tool sẽ tự clear active_martial_art_id nếu gỡ đúng công pháp đang active.", AdminEditorKind.CharacterMartialArtWorkspace),
            new("character_item_workspace", "Designer Workspace", "Character Items Workspace", string.Empty, null, "Workspace để tick item đang sở hữu theo item template cho từng nhân vật.", "Chọn nhân vật ở bảng trên. Danh sách item template bên dưới hiện checkbox sở hữu. Tick để cấp 1 item mặc định cho nhân vật, bỏ tick để gỡ toàn bộ item cùng template của nhân vật. Tool sẽ tự dọn các bảng phụ như equipment row, soil row và bonus stat liên quan.", AdminEditorKind.CharacterItemWorkspace),
            new("character_skill_workspace", "Designer Workspace", "Character Skills Workspace", string.Empty, null, "Workspace để tick skill đã sở hữu cho từng nhân vật.", "Chọn nhân vật ở bảng trên. Danh sách skill source bên dưới hiện checkbox sở hữu theo từng martial_art_skill. Tick để cấp skill cho nhân vật, bỏ tick để gỡ skill và dọn loadout. Tool sẽ tự đảm bảo player_martial_arts tồn tại khi cần để dữ liệu hợp lệ.", AdminEditorKind.CharacterSkillWorkspace),
