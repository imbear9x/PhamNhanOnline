...
public enum MessageCode : int
{
    ...
    PillRecipeInvalid = 3047,
    PillRecipeNotLearned = 3048,
    ItemOnCooldown = 3049,
    AlchemyInputInvalid = 3050,
    AlchemyCraftFailed = 3051,
    PracticeAlreadyActive = 3052,
    PracticeNotActive = 3053,
    PracticeRequiresPrivateHome = 3054,
