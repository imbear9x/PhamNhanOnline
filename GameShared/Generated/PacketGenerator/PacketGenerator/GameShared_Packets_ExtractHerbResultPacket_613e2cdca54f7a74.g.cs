...
public partial class ExtractHerbResultPacket
{
    private ulong _mask;
    ...
    public bool HasMamNonReturned => (_mask & (1UL << 3)) != 0;

    public bool TryGetMamNonReturned(out bool? value)
    {
        value = MamNonReturned;
        return HasMamNonReturned;
    }
    ...
    public void Serialize(BinaryWriter writer)
    {
        ...
        if (!global::System.Collections.Generic.EqualityComparer<bool?>.Default.Equals(MamNonReturned, default!)) mask |= 1UL << 3;
        ...
        if ((mask & (1UL << 3)) != 0)
            global::GameShared.Packets.PacketWriter.Write(writer, MamNonReturned.Value);
    }
    ...
    public void Deserialize(BinaryReader reader)
    {
        ...
        if ((_mask & (1UL << 3)) != 0)
            MamNonReturned = (bool?)(global::GameShared.Packets.PacketReader.ReadBool(reader));
    }
}
