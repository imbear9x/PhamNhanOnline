...
public partial class EnemyMovementDecisionPacket
{
    private ulong _mask;
    ...
    public bool HasEnemy => (_mask & (1UL << 2)) != 0;

    public bool TryGetEnemy(out global::GameShared.Models.EnemyRuntimeModel? value)
    {
        value = Enemy;
        return HasEnemy;
    }
    ...
    public void Serialize(BinaryWriter writer)
    {
        ...
        if ((mask & (1UL << 2)) != 0)
            global::GameShared.Packets.PacketModelSerializer.Write(writer, Enemy.Value);
    }
    ...
    public void Deserialize(BinaryReader reader)
    {
        ...
        if ((_mask & (1UL << 2)) != 0)
            Enemy = (global::GameShared.Models.EnemyRuntimeModel?)(global::GameShared.Packets.PacketModelSerializer.Read<global::GameShared.Models.EnemyRuntimeModel>(reader));
    }
}
