...
public partial class GetUnreadNotificationsResultPacket
{
    private ulong _mask;
    ...
    public bool HasNotifications => (_mask & (1UL << 2)) != 0;

    public bool TryGetNotifications(out global::System.Collections.Generic.List<global::GameShared.Models.PlayerNotificationModel>? value)
    {
        value = Notifications;
    ...
    public void Serialize(BinaryWriter writer)
    {
        ...
        if (!global::System.Collections.Generic.EqualityComparer<global::System.Collections.Generic.List<global::GameShared.Models.PlayerNotificationModel>?>.Default.Equals(Notifications, default!)) mask |= 1UL << 2;
        ...
        if ((mask & (1UL << 2)) != 0)
            global::GameShared.Packets.PacketModelSerializer.WriteList(writer, Notifications);
    }
    ...
    public void Deserialize(BinaryReader reader)
    {
        ...
        if ((_mask & (1UL << 2)) != 0)
            Notifications = (global::System.Collections.Generic.List<global::GameShared.Models.PlayerNotificationModel>?)global::GameShared.Packets.PacketModelSerializer.ReadList<global::GameShared.Models.PlayerNotificationModel>(reader)!;
    }
}
