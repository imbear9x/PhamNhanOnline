...
public partial class SkillImpactResolvedPacket
{
    ...
    public bool HasSuccess => (_mask & (1UL << 11)) != 0;
    ...
    public bool HasCode => (_mask & (1UL << 12)) != 0;
    ...
    public bool HasDamageApplied => (_mask & (1UL << 13)) != 0;
    ...
    public bool HasRemainingHp => (_mask & (1UL << 14)) != 0;
    ...
    public bool HasIsKilled => (_mask & (1UL << 15)) != 0;
    ...
    public bool HasResolvedAtUnixMs => (_mask & (1UL << 16)) != 0;
    ...
    public void Serialize(BinaryWriter writer)
    {
        ...
        if (!global::System.Collections.Generic.EqualityComparer<bool?>.Default.Equals(Success, default!)) mask |= 1UL << 11;
        if (!global::System.Collections.Generic.EqualityComparer<global::GameShared.Messages.MessageCode?>.Default.Equals(Code, default!)) mask |= 1UL << 12;
        if (!global::System.Collections.Generic.EqualityComparer<int?>.Default.Equals(DamageApplied, default!)) mask |= 1UL << 13;
        if (!global::System.Collections.Generic.EqualityComparer<int?>.Default.Equals(RemainingHp, default!)) mask |= 1UL << 14;
        if (!global::System.Collections.Generic.EqualityComparer<bool?>.Default.Equals(IsKilled, default!)) mask |= 1UL << 15;
        if (!global::System.Collections.Generic.EqualityComparer<long?>.Default.Equals(ResolvedAtUnixMs, default!)) mask |= 1UL << 16;
