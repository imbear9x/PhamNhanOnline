...
public partial class GetLearnedPillRecipesResultPacket
{
    private ulong _mask;
    ...
    public bool HasRecipes => (_mask & (1UL << 2)) != 0;

    public bool TryGetRecipes(out global::System.Collections.Generic.List<global::GameShared.Models.LearnedPillRecipeModel>? value)
    {
        value = Recipes;
        return HasRecipes;
    }
    ...
    public void Serialize(BinaryWriter writer)
    {
        ...
        if (!global::System.Collections.Generic.EqualityComparer<global::System.Collections.Generic.List<global::GameShared.Models.LearnedPillRecipeModel>?>.Default.Equals(Recipes, default!)) mask |= 1UL << 2;
        ...
        if ((mask & (1UL << 2)) != 0)
            global::GameShared.Packets.PacketModelSerializer.WriteList(writer, Recipes);
    }
    ...
    public void Deserialize(BinaryReader reader)
    {
        ...
        if ((_mask & (1UL << 2)) != 0)
            Recipes = (global::System.Collections.Generic.List<global::GameShared.Models.LearnedPillRecipeModel>?)global::GameShared.Packets.PacketModelSerializer.ReadList<global::GameShared.Models.LearnedPillRecipeModel>(reader)!;
    }
}
