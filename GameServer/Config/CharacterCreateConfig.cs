...
public sealed class CharacterCreateConfig
{
    ...
    public int FallbackRealmLifespanDays { get; set; } = 120;
    ...
    public int BaseSense { get; set; } = 10;
    public int BaseStamina { get; set; } = 100;
    public int LifespanBonusDays { get; set; } = 0;
    public double BaseLuck { get; set; } = 0.01d;
